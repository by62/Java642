...
public class SAXTest {
    ...
    public ArrayList<Book> parseXML(){
        ...
        try {
            ...
            System.out.println("一共有几本书:"+handler.getBookArrayList().size()+"本");
        ...
        return handler.getBookArrayList();
...
////            transformer.setOutputProperties(ENCODING,"UTF-8");
////            transformer.setOutputProperties(INDENT,"YES");
//            File f = new File(  "src/res/newbooks.xml"  );
//            if (!f.exists())
//            {
//                f.createNewFile();
...
//                if (book.getLanguage()!= null && book.getLanguage().trim().equals( "" )) {
//                    attributes.clear();
//                    transformerHandler.startElement( "", "", "Language", attributes );
